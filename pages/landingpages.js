...
const landingpages = () => {
  return (
    <div className=" w-full h-full bg-[#EEEEEE] grid grid-cols-1">
      <div id="nav" className="w-full h-fit px-24 sticky top-10">
        <nav className="flex items-center justify-between w-full h-fit bg-[#E3E3E8] p-6 rounded-full px-12">
          ...
          <div className="grid grid-cols-2 gap-4 w-fit">
            <Link
              href="/"
              className="px-5 py-2 border border-[#292929] text-center rounded-lg hover:bg-[#292929] hover:text-white"
            >
              Login
            </Link>
            <Link
              href="/register"
              className="px-5 py-2 text-center rounded-lg bg-[#292929] hover:bg-[#292929] hover:text-white text-white"
            >
              Register
            </Link>
          </div>
      ...
      <div
        id="Header"
        className="w-full top-52  grid grid-cols-2 pt-24 px-24 h-fit"
      >
        <div className="p-20">
          <h1 className="text-3xl font-bold mb-4 text-[#292929]">
      ...
      <div id="Trusted" className="w-full  grid grid-cols-1 mt-9 h-fit px-24">
        ...
        <h1 className="text-6xl font-bold mb-4 text-[#292929] mx-auto">
          150+ <span className="text-sm">Pemilik Usaha</span>
        </h1>
        <h1 className="text-md font-bold mb-4 text-[#292929] mx-auto">
          Tersebar di seluruh Indonesia
        </h1>
      </div>
      <div
        id="feture"
        className="w-full grid grid-cols-2 mt-9 px-24 gap-10 h-fit"
      >
        <h1 className="text-2xl font-bold mb-4 text-[#292929] mx-auto mt-10 col-span-2">
          Fitur Kami
        </h1>
        <div
          id="card1"
          className="w-full h-fit bg-[#FEFEFE] p-6 rounded-lg shadow-lg"
        >
        ...
        <div
          id="card1"
          className="w-full h-full bg-[#292929] p-6 rounded-lg shadow-lg"
        >
          <div className="w-fit bg-[#292929] p-5 rounded-full">
          ...
          <h2 className="text-sm font-medium mb-4 text-[#B0A7A7] ">
            Analitik sederhana untuk keputusan bisnis yang cerdas. Ketahui
            performa warung Anda
          </h2>
        </div>
        <div
          id="card1"
          className="w-full h-fit bg-[#292929] p-6 rounded-lg shadow-lg"
        >
          <div className="w-fit bg-[#292929] p-5 rounded-full">
      ...
      <div
        id="testi"
        className="w-full grid grid-cols-1 mt-9 h-fit px-24 gap-10"
      >
        <h1 className="text-2xl font-bold mb-4 text-[#292929] mx-auto">
          Testimoni
        </h1>
        <div className="grid grid-cols-4 h-fit w-full gap-10">

          <div className="grid grid-cols-1 w-full h-full bg-white p-6 rounded-lg shadow-lg ">
            <div className="w-full mx-auto text-center ">
              ...
              ></img>
              <h2 className="text-xl font-bold mb-1 text-[#292929]  mt-2">
                Ayu Yunita
              </h2>
              <h3 className="text-sm font-light mb-3 text-[#292929]">
                Pemilik Warung Sederhana
              </h3>
            </div>
            <div className="w-full mx-auto text-center text-xs italic text-[#646464] font-light">
              <p>
                Sejak pakai aplikasi ini, saya nggak pusing lagi cek stok
                barang. Semua sudah tercatat otomatis, dan saya bisa fokus
                melayani pelanggan. Sangat membantu untuk warung kecil seperti
                saya!{" "}
              </p>
            </div>
          </div>
